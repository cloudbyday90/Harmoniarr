...
function collectRegisteredRoutes() {
  ...
  registerMissingMusicRoutes(app, {
    ...
    getMissingMusicDownloaderHandoff: asyncNoopResult({ handoff: null }),
    ...
    startMissingMusicDecisionDownload: asyncNoopResult({ operation: {} }),
  });
  ...
  registerPushRoutes(app, {
    ...
    subscribe: asyncNoopResult({ id: 'sub-1' }),
    unsubscribe: asyncNoopResult(),
    requireSession: asyncNoopResult({ appUserId: 'user-1' }),
  });
  ...
  registerLibraryRoutes(app, {
    ...
    getMediaRequestReassignmentHistory: asyncNoopResult([]),
    getRequestMetadata: () => ({}),
    requireCsrf: () => {},
    requireFreshAdminSession: asyncNoopResult({ appUserId: 'user-1' }),
