...
export const releaseWorkflowSummaryCliOptions = Object.freeze({
  ...
  'browser-smoke-screenshots-artifact-name': { type: 'string' },
  ...
  switch (summaryKind) {
    ...
    case 'verify-published-image':
      return {
        ...
        browserSmokeScreenshotsArtifactName: getOptionalStringInput(
          resolvedValues,
          'browser-smoke-screenshots-artifact-name',
          'HARMONIARR_SUMMARY_BROWSER_SMOKE_SCREENSHOTS_ARTIFACT_NAME',
          env,
        ),
        imageRef: getRequiredStringInput(resolvedValues, 'image-ref', 'HARMONIARR_SUMMARY_IMAGE_REF', env),
