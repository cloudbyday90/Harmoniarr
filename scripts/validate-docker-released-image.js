...
await runDirectScriptTask(import.meta, {
    ...
    renderSuccessMessage: ({ embeddedPostgresPersistence, existingDataRestart, evidencePath: resolvedEvidencePath, freshInstall, imageRef, port, projectName, startupFailure }) => {
