...
export function searchMusicBrainzArtists({ query, limit, signal } = {}) {
  return apiRequest(`/api/v1/metadata/musicbrainz/artists/search${buildQueryString({ q: query, limit })}`, { signal });
}
