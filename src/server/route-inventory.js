...
export const serverRouteInventory = Object.freeze([
  ...
  { method: 'POST', path: '/api/v1/library/media-requests/:mediaRequestId/external-review/collection/start', access: 'admin', area: 'library', kind: 'mutation' },
  { method: 'POST', path: '/api/v1/library/media-requests/:mediaRequestId/external-review/collection/items/:collectionItemId/exclude', access: 'admin', area: 'library', kind: 'mutation' },
  { method: 'POST', path: '/api/v1/library/media-requests/:mediaRequestId/external-review/collection/finalize', access: 'admin', area: 'library', kind: 'mutation' },
  ...
  { method: 'POST', path: '/api/v1/acquisition/releases/:wantedReleaseId/allow-fallback-quality', access: 'authenticated', area: 'music-queue', kind: 'mutation' },
  ...
  { method: 'GET', path: '/api/v1/activity/ignored-source-users', access: 'admin', area: 'activity', kind: 'read' },
  { method: 'GET', path: '/api/v1/activity/source-user-ignore-suggestions', access: 'admin', area: 'activity', kind: 'read' },
  { method: 'POST', path: '/api/v1/activity/ignored-source-users', access: 'admin', area: 'activity', kind: 'mutation' },
  { method: 'DELETE', path: '/api/v1/activity/ignored-source-users/:username', access: 'admin', area: 'activity', kind: 'mutation' },
  ...
  { method: 'GET', path: '/api/v1/metadata/artists/:artistId/operator/discography', access: 'authenticated', area: 'metadata', kind: 'read' },
  { method: 'GET', path: '/api/v1/metadata/artists/:artistId/discography', access: 'authenticated', area: 'metadata', kind: 'read' },
  ...
  { method: 'POST', path: '/api/v1/metadata/artists/:artistId/operator/release-groups/:releaseGroupId/manual-edition-selection', access: 'authenticated', area: 'metadata', kind: 'mutation' },
  ...
  { method: 'POST', path: '/api/v1/downloader/transfers/:username/:id/actions', access: 'admin', area: 'downloader', kind: 'mutation' },
  { method: 'POST', path: '/api/v1/downloader/actions/clear-completed', access: 'admin', area: 'downloader', kind: 'mutation' },
  ...
  { method: 'POST', path: '/api/v1/library/releases/:metadataReleaseId/visibility', access: 'authenticated', area: 'library', kind: 'mutation' },
  ...
  { method: 'POST', path: '/api/v1/library/media-requests/bulk-cancel', access: 'authenticated', area: 'requests', kind: 'mutation' },
  { method: 'GET', path: '/api/v1/library/media-requests/:mediaRequestId', access: 'authenticated', area: 'requests', kind: 'read' },
  { method: 'GET', path: '/api/v1/library/media-requests/:mediaRequestId/pipeline', access: 'authenticated', area: 'requests', kind: 'read' },
  { method: 'GET', path: '/api/v1/library/media-requests/:mediaRequestId/events', access: 'authenticated', area: 'requests', kind: 'read' },
  { method: 'POST', path: '/api/v1/library/media-requests/:mediaRequestId/cancel', access: 'authenticated', area: 'requests', kind: 'mutation' },
