...
export function createSystemModule({
  ...
  systemBackupExportService = backupExportService ?? createBackupExportService({
    ...
    listOperatorArtistMonitoringForBackup: operatorArtistMonitoringStore?.listOperatorArtistMonitoringSnapshot,
    listOperatorReleaseGroupSelectionsForBackup: operatorReleaseGroupSelectionStore?.listOperatorReleaseGroupSelectionsSnapshot,
    listOperatorTrackOverridesForBackup: operatorTrackOverrideStore?.listOperatorTrackOverridesSnapshot,
  ...
  systemBackupRestoreApplyService = backupRestoreApplyService ?? createBackupRestoreApplyService({
    ...
    replaceOperatorArtistMonitoring: operatorArtistMonitoringStore?.replaceOperatorArtistMonitoringSnapshot,
    replaceOperatorReleaseGroupSelections: operatorReleaseGroupSelectionStore?.replaceOperatorReleaseGroupSelectionsSnapshot,
    replaceOperatorTrackOverrides: operatorTrackOverrideStore?.replaceOperatorTrackOverridesSnapshot,
