...
export const criticalSchemaAnchors = Object.freeze({
  columns: Object.freeze([
    ...
    { table: 'library_external_request_collections', column: 'revision' },
    { table: 'library_external_request_collections', column: 'requested_for_user_id' },
    { table: 'library_external_request_collection_items', column: 'decision' },
    { table: 'provider_ingest_requests', column: 'ingest_key' },
    { table: 'provider_ingest_requests', column: 'next_page_cursor' },
    ...
    { table: 'metadata_artist_refresh_state', column: 'metadata_artist_id' },
    { table: 'metadata_artist_refresh_state', column: 'last_refreshed_at' },
    { table: 'metadata_artist_refresh_state', column: 'next_refresh_at' },
    { table: 'metadata_provider_response_cache', column: 'cache_namespace' },
    { table: 'metadata_provider_response_cache', column: 'cache_key' },
    { table: 'metadata_provider_response_cache', column: 'fetched_at' },
    { table: 'library_wanted_releases', column: 'app_user_id' },
    { table: 'operator_library_release_visibility', column: 'app_user_id' },
    { table: 'operator_library_release_visibility', column: 'metadata_release_id' },
    { table: 'operator_library_release_visibility', column: 'visibility_state' },
    { table: 'operator_release_group_selection', column: 'selection_origin' },
  ...
  constraints: Object.freeze([
    ...
    { table: 'library_external_request_collection_items', constraint: 'external_collection_item_identity_unique' },
    { table: 'library_external_request_collection_items', constraint: 'external_collection_item_decision_consistent' },
    ...
    { table: 'metadata_artist_refresh_state', constraint: 'metadata_artist_refresh_state_pkey' },
    { table: 'metadata_artist_refresh_state', constraint: 'metadata_artist_refresh_state_metadata_artist_id_fkey' },
    { table: 'metadata_provider_response_cache', constraint: 'metadata_provider_response_cache_namespace_key_unique' },
    { table: 'library_wanted_releases', constraint: 'library_wanted_releases_user_release_unique' },
    {
      table: 'operator_library_release_visibility',
      constraint: 'operator_library_release_visibility_user_release_unique',
    },
    {
      table: 'operator_library_release_visibility',
      constraint: 'operator_library_release_visibility_state_check',
    },
    { table: 'operator_track_override', constraint: 'operator_track_override_identity_check' },
    { table: 'operator_release_group_selection', constraint: 'operator_release_group_selection_origin_check' },
    { table: 'operator_release_group_selection', constraint: 'operator_release_group_selection_origin_source_check' },
  ...
  indexes: Object.freeze([
    ...
    { index: 'operator_artist_monitoring_refresh_eligibility_idx' },
  ...
  tables: Object.freeze([
    ...
    { table: 'library_external_request_collections' },
    { table: 'library_external_request_collection_items' },
    { table: 'schema_migrations' },
    { table: 'operation_runs' },
    { table: 'media_requests' },
    { table: 'operator_artist_monitoring' },
    { table: 'metadata_artist_refresh_state' },
    { table: 'metadata_provider_response_cache' },
