...
-- Migration: 20260601_114544_search_attempt_tracking_library_discovery_requests.sql
-- Checksum: 6a085d894cabc8e6f4336c07764f0c82937cd4fd98d77b5c6778da42b8e103ac
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260601_114544',
  '20260601_114544_search_attempt_tracking_library_discovery_requests.sql',
  'search_attempt_tracking_library_discovery_requests',
  '6a085d894cabc8e6f4336c07764f0c82937cd4fd98d77b5c6778da42b8e103ac',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260625_030000_operator_track_override_baseline.sql
-- Checksum: 20d31911599647c5a63746be7d6dc2e1f429a0d6c9d80f8917aa53c4b1f2a93f
--
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
...
VALUES (
  '20260625_030000',
  '20260625_030000_operator_track_override_baseline.sql',
  'operator_track_override_baseline',
  '20d31911599647c5a63746be7d6dc2e1f429a0d6c9d80f8917aa53c4b1f2a93f',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260625_040000_operator_artist_reconciliation_snapshot_baseline.sql
-- Checksum: 6c4289cded5537c279f56f34c47aeaa6d199a74b1fab4b50a3d2040fbcafd738
--
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
...
VALUES (
  '20260625_040000',
  '20260625_040000_operator_artist_reconciliation_snapshot_baseline.sql',
  'operator_artist_reconciliation_snapshot_baseline',
  '6c4289cded5537c279f56f34c47aeaa6d199a74b1fab4b50a3d2040fbcafd738',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260626_010000_slskd_browse_cache.sql
-- Checksum: 0f37f6713fe50737351b1a8d3227b399196a2c6ceed10c18e0c94a8d2775e679
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260626_010000',
  '20260626_010000_slskd_browse_cache.sql',
  'slskd_browse_cache',
  '0f37f6713fe50737351b1a8d3227b399196a2c6ceed10c18e0c94a8d2775e679',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260627_000000_source_user_outcome_events.sql
-- Checksum: 3e50abe4134fe8b6bcbb617f64fcf10ce9c8ef8394a33ebabe4f6509baee2270
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260627_000000',
  '20260627_000000_source_user_outcome_events.sql',
  'source_user_outcome_events',
  '3e50abe4134fe8b6bcbb617f64fcf10ce9c8ef8394a33ebabe4f6509baee2270',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
VALUES (
  '20260628_000000',
  '20260628_000000_source_user_outcome_quality.sql',
  'source_user_outcome_quality',
  '05feb927ee1b14f3eb17063bdc4db8e0395127a6ec5a7436e2ec36c763d0b9e2',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260628_000001_source_user_ignore_entries.sql
-- Checksum: c693b32e0a45919662b26b1e2f81b495809e44697e02bfb37da59c9ec5643c41
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260628_000001',
  '20260628_000001_source_user_ignore_entries.sql',
  'source_user_ignore_entries',
  'c693b32e0a45919662b26b1e2f81b495809e44697e02bfb37da59c9ec5643c41',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260628_000002_source_user_spectral_jobs.sql
-- Checksum: 603afe3f91c80e91eaea5b9774d510fd600c3dc54e51f62912506e1e5c1ace71
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260628_000002',
  '20260628_000002_source_user_spectral_jobs.sql',
  'source_user_spectral_jobs',
  '603afe3f91c80e91eaea5b9774d510fd600c3dc54e51f62912506e1e5c1ace71',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260629_000001_spectral_cache_and_retroactive.sql
-- Checksum: 9a10433bfe9271585ecfce3e01083574d40890856080a6c4a2bd0f48bd93cf3d
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
-- Migration: 20260630_040000_operator_library_release_visibility.sql
-- Checksum: 38c1e4ef41e10010a356e020126df68e52f74830f6b96f28c3d2a9e984f2a45e
--
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
...
VALUES (
  '20260630_040000',
  '20260630_040000_operator_library_release_visibility.sql',
  'operator_library_release_visibility',
  '38c1e4ef41e10010a356e020126df68e52f74830f6b96f28c3d2a9e984f2a45e',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260725_212102_music_queue_activity_lifecycle_events.sql
-- Checksum: d7a4ed3ee22ba7a602d18f097ca09a70f9a115aa88c21b4686dbb33a1a3231fb
/*
 * Harmoniarr - Soulseek-native music library management
 * Copyright (C) 2026 Harmoniarr Contributors
 *
...
VALUES (
  '20260725_212102',
  '20260725_212102_music_queue_activity_lifecycle_events.sql',
  'music_queue_activity_lifecycle_events',
  'd7a4ed3ee22ba7a602d18f097ca09a70f9a115aa88c21b4686dbb33a1a3231fb',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260726_011032_add_music_queue_activity_milestones.sql
-- Checksum: be7b37ae3005ba2976b4316ef9a4f55871fed1a018e24d354580e938a565db3c
-- forward-only migration
BEGIN;
...
VALUES (
  '20260726_011032',
  '20260726_011032_add_music_queue_activity_milestones.sql',
  'add_music_queue_activity_milestones',
  'be7b37ae3005ba2976b4316ef9a4f55871fed1a018e24d354580e938a565db3c',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260726_125059_add_music_queue_search_started_activity_event.sql
-- Checksum: 40421b43540400f1e46121dc2e6ebc15e22584863ff250401edad664668c58a8
/*
 * Harmoniarr - Soulseek-native music library management
 * Copyright (C) 2026 Harmoniarr Contributors
 *
...
VALUES (
  '20260726_125059',
  '20260726_125059_add_music_queue_search_started_activity_event.sql',
  'add_music_queue_search_started_activity_event',
  '40421b43540400f1e46121dc2e6ebc15e22584863ff250401edad664668c58a8',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260730_213104_operator_shared_discovery_correlation.sql
-- Checksum: 00f779a7369e2d558eb8e417d17af9cfc308e9e740ce45d3f6751f9f900cb8e1
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260730_213104',
  '20260730_213104_operator_shared_discovery_correlation.sql',
  'operator_shared_discovery_correlation',
  '00f779a7369e2d558eb8e417d17af9cfc308e9e740ce45d3f6751f9f900cb8e1',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260730_214500_import_execution_terminal_item_status.sql
-- Checksum: a9b0bad0c48090d7d0556391ddc72379462534571fbc4a2eef72e80cfb17acf2
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260730_214500',
  '20260730_214500_import_execution_terminal_item_status.sql',
  'import_execution_terminal_item_status',
  'a9b0bad0c48090d7d0556391ddc72379462534571fbc4a2eef72e80cfb17acf2',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260822_121456_metadata_provider_response_cache.sql
-- Checksum: d4f3f6cfae9ff3899ec69b2d72797d5b4ad69936cd3e5ac050694e5a66482d52
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260822_121456',
  '20260822_121456_metadata_provider_response_cache.sql',
  'metadata_provider_response_cache',
  'd4f3f6cfae9ff3899ec69b2d72797d5b4ad69936cd3e5ac050694e5a66482d52',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260824_232158_control_plane_idempotency_in_progress_reservations.sql
-- Checksum: e8bdb2c4a0981a95387e615ce85d665baf05e5e00bdd8c39aa86effb23a95408
--
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
...
VALUES (
  ...
  'control_plane_idempotency_in_progress_reservations',
  'e8bdb2c4a0981a95387e615ce85d665baf05e5e00bdd8c39aa86effb23a95408',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260825_113500_import_apply_run_item_recovery_status.sql
-- Checksum: fb93608fbdccdc75caa0ea883136f25c16be5c9386e970acb0bffdb560dd221f
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
ALTER TABLE import_apply_run_items
  DROP CONSTRAINT IF EXISTS import_apply_run_items_item_status_check;

ALTER TABLE import_apply_run_items
  ADD CONSTRAINT import_apply_run_items_item_status_check
  CHECK (item_status IN (
    'ready',
    'ready_with_warnings',
    'applying',
...
VALUES (
  '20260825_113500',
  '20260825_113500_import_apply_run_item_recovery_status.sql',
  'import_apply_run_item_recovery_status',
  'fb93608fbdccdc75caa0ea883136f25c16be5c9386e970acb0bffdb560dd221f',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260825_115448_backup_artifact_file_operation_recovery.sql
-- Checksum: ef9a6da4287b084bc84a8bc7f227e3eea60da45cd750da8d00fbd43ae72ded00
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260825_115448',
  '20260825_115448_backup_artifact_file_operation_recovery.sql',
  'backup_artifact_file_operation_recovery',
  'ef9a6da4287b084bc84a8bc7f227e3eea60da45cd750da8d00fbd43ae72ded00',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260825_181842_selection_origin_evidence.sql
-- Checksum: 81dbf8756ee9cf28a77679a9dc3d1fefe0f9800012ce704a35009447babb36a2
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260825_181842',
  '20260825_181842_selection_origin_evidence.sql',
  'selection_origin_evidence',
  '81dbf8756ee9cf28a77679a9dc3d1fefe0f9800012ce704a35009447babb36a2',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260825_191210_import_execution_transfer_links.sql
-- Checksum: a1e76b56ebe4cdb4038439201b1ef4aaec329c4b509c9bc9c0be1ad93dee0a00
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260825_191210',
  '20260825_191210_import_execution_transfer_links.sql',
  'import_execution_transfer_links',
  'a1e76b56ebe4cdb4038439201b1ef4aaec329c4b509c9bc9c0be1ad93dee0a00',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260825_220000_import_execution_handoff_confirmation_status.sql
-- Checksum: 87625f92c4a87aa0c2b79c4eb3dcf831c8323e00760725ab4a82bd3668141578
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: you can redistribute it and/or modify
...
VALUES (
  '20260825_220000',
  '20260825_220000_import_execution_handoff_confirmation_status.sql',
  'import_execution_handoff_confirmation_status',
  '87625f92c4a87aa0c2b79c4eb3dcf831c8323e00760725ab4a82bd3668141578',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260911_084039_external_collection_enumeration_and_review.sql
-- Checksum: 5087ec0d6fd6119649f53e8e1394dd711943a0e103279f26ef12c59b7f3c10f3
-- Harmoniarr - Soulseek-native music library management
-- Copyright (C) 2026 Harmoniarr Contributors
--
-- This program is free software: licensed under GPL-3.0
...
VALUES (
  '20260911_084039',
  '20260911_084039_external_collection_enumeration_and_review.sql',
  'external_collection_enumeration_and_review',
  '5087ec0d6fd6119649f53e8e1394dd711943a0e103279f26ef12c59b7f3c10f3',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
...
-- Migration: 20260912_081644_add_request_lifecycle_activity_events.sql
-- Checksum: f264e7f549817f22b975cd6a5f4f904977c65bb02b198fd8cd035f4d9f42cb2a
/*
 * Harmoniarr - Soulseek-native music library management
 * Copyright (C) 2026 Harmoniarr Contributors
 *
...
VALUES (
  '20260912_081644',
  '20260912_081644_add_request_lifecycle_activity_events.sql',
  'add_request_lifecycle_activity_events',
  'f264e7f549817f22b975cd6a5f4f904977c65bb02b198fd8cd035f4d9f42cb2a',
  'applied'
)
ON CONFLICT (filename) DO UPDATE
SET migration_key = EXCLUDED.migration_key,
