...
The outbound endpoint follow-up is implemented in the separate [push endpoint security outcome](PUSH_ENDPOINT_SECURITY_OUTCOME.md), with its design, validation, and next release item.
