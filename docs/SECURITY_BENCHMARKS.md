...
|---------|-------------------|--------|
| Use trusted base image | Use official Node 24.19 LTS Alpine image for builder stages and pin the runtime image separately | Implemented baseline |
...
| Practice | Target |
|----------|--------|
| Stable runtime | Node 24 LTS baseline (Node 24.19.0 target) |
