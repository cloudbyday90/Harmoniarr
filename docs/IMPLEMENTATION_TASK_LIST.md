...
- [ ] Implement restore preview, restore apply, maintenance lock entry/exit, and restore operation-run/event history.
  ...
  - Remaining work is to finish end-to-end recovery UI flows and evolve trust/override snapshots into richer first-class workflow domain tables once those schemas are finalized.
