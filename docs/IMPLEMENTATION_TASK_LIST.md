...
- [ ] Verify maintenance locks pause unsafe writes and background work consistently.
  ...
  - Remaining work is now concentrated in in-flight worker interruption or requeue proof beyond the fail-closed start routes, paused heartbeat triggers, and paused queue-dispatch boundary.
